...
@section('main-content')
    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner d-flex">
                        <ul class="bread-list">
                            <li class="active"><a href="">السلة
                                    <i class="ti-arrow-left"></i>
                                </a></li>
                            {{-- <li><a href="{{ 'home' }}">الرئيسة<i class="ti-arrow-right"></i></a></li> --}}
                            <li><a href="javascript:void(0)" onclick="window.history.back();">الرجوع
                                </a></li>
                                ...
                                @else
                                    <tr>
                                        <td class="text-center">
                                            ليس هناك منتجات في السلة. <a href="{{ route('product-grids') }}"
                                                style="color:blue;">استمرار التسوق</a>
                                ...
                                <div class="right">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{ Helper::totalCartPrice() }}">
                                            المجموع<span>${{ number_format(Helper::totalCartPrice(), 2) }}</span></li>

                                        @if (session()->has('coupon'))
                                            <li class="coupon_price" data-price="{{ Session::get('coupon')['value'] }}">
                                                حصلت على
                                                خصم<span>${{ number_format(Session::get('coupon')['value'], 2) }}</span>
                                            </li>
                                        @endif
                                        @php
                                        ...
                                        @if (session()->has('coupon'))
                                            <li class="last" id="order_total_price">
                                                ادفع<span>${{ number_format($total_amount, 2) }}</span></li>
                                        @else
                                            <li class="last" id="order_total_price">
                                                ادفع<span>${{ number_format($total_amount, 2) }}</span></li>
                                        @endif
                                    ...
                                    <div class="button5">
                                        <a href="{{ route('checkout') }}" class="btn">دفع</a>
