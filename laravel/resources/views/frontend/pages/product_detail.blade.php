            ...
            <div class="row">
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            <li class="active"><a href="">تفاصيل المنتج
                                    <i class="ti-arrow-left"></i>
                                </a></li>
                            {{-- <li><a href="{{ route('previous') }}">الرئيسية<i class="ti-arrow-right"></i></a></li> --}}
                            <li><a href="javascript:void(0)" onclick="window.history.back(); ">السابقة
                                </a></li>
                                ...
                                <div class="product-buy">
                                    <form action="{{ route('single-add-to-cart') }}" method="POST">
                                        ...
                                        <div class="add-to-cart mt-4">
                                            <button type="submit" class="btn">إضافة الى السلة</button>
                                    ...
                                    @endif
                                    <p class="availability">الكمية المتوفرة : @if ($product_detail->stock > 0)
                                ...
                                <div class="nav-main">
                                    ...
                                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                                        <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                href="#description" role="tab">الوصف</a></li>
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#reviews"
                                                role="tab">التعليقات والمراجعات</a></li>
                                    </ul>
                                    <!--/ End Tab Nav -->
                                </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="comment-review">
                                                        <div class="add-review">
                                                            <h5>إضف مراجعة</h5>
                                                            <p>لن يتم نشر بريدك الالكتروني . الحقول المطلوبة فقط</p>
                                                        </div>
                                                        <h4>تقييمك للمنتج <span class="text-danger">*</span></h4>
                                                        <div class="review-inner">
                                                            ...
                                                            @else
                                                                <p class="text-center p-5">
                                                                    انت بحاجةالى <a href="{{ route('login.form') }}"
                                                                        style="color:rgb(54, 54, 204)">تسجيل الدخول </a> او <a
                                                                        style="color:blue"
                                                                        href="{{ route('register.form') }}"> أنشاء حساب </a>
                                                    ...
                                                    <div class="ratting-main">
                                                        <div class="avg-ratting">
                                                            ...
                                                            <span>قائم على {{ $product_detail->getReview->count() }}
                                                                التعلقيات</span>
                                                        </div>
