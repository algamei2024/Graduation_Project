...
@section('store')
    <div class="card shadow mb-4" style="text-align: right;">
        ...
        <div class="card-header py-3">
            <h4 class=" font-weight-bold">الملف التعريفي</h4>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body mt-4 ml-2" style="display: flex;flex-direction: column">
                            <h5 class="card-title text-left" style="display: flex"><small><i class="fas fa-user"></i>
                                    {{ $profile->name }}</small>
                            </h5>
                            <p style="display: flex" class="card-text text-left"><small><i class="fas fa-envelope"></i>
                ...
                <div class="col-md-8">
                    <form class="border px-4 pt-2 pb-3" method="POST" action="{{ route('profile.user.update') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input style="text-align: right;" id="inputTitle" type="text" name="name"
                                placeholder="Enter name" value="{{ $profile->name }}" class="form-control">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input style="text-align: right;" id="inputEmail" type="email" name="email"
                                placeholder="Enter email" value="{{ $profile->email }}" class="form-control">
                            @error('email')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
