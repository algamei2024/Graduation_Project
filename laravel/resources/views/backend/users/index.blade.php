    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            ...
            <a href="{{ route('users.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> إضافة مستخدم</a>
        </div>
        <div class="card-body">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            // اعدادات يتم تطبيقها على كل طلب ajax لاحق
            $.ajaxSetup({
                headers: {
            ...
            $('.dltBtn').click(function(e) {
                ...
                //swal دالة من مكتبة SweetAlert من مكاتب الجافا سكريبت مخصصة لانشاء نوافذ منبثقة
                swal({
                        title: "Are you sure?",
