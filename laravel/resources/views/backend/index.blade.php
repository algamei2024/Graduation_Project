...
@section('main-content')
    <div class="container-fluid">
        ...
        <div class="row">
                ...
                <div class="card border-left-primary shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">الأصناف</div>
            ...
            {{-- ///// --}}
            {{-- نسخ رابط المتجر --}}
            <div class="card shadow h-100 py-2 mb-4" dir="ltr">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-bg-primary text-uppercase mb-1">رابط المتجر</div>
                            <div class="h5 mr-5 font-weight-bold text-gray-800">
                                @php
                                    $trader_id = auth()->guard('trader')->id();
                                    $storeInfo = \App\Models\StoreInformation::where('admin_id', $trader_id)->first();
                                    $storeName = $storeInfo['name'];
                                @endphp
                                <span class="storename">http://127.0.0.1:8000/store/{{ $storeName }}</span>
                            </div>
                        </div>
                        <div class="text-center mt-4" style="cursor: pointer;" onclick="copyNameStore()">
                            <i class="fas fa-copy fa-2x text-gray-300"></i>
                            <i class="fas fa-check"
                                style="color: green; display: none; font-size: 1.5em; transition: opacity 0.5s ease; opacity: 1;"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-5">
                <div class="card shadow mb-4">
                    <!-- Card Header - Dropdown -->
                    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">المتسخدمون</h6>
                    </div>
                    <!-- Card Body -->
                    <div class="card-body" style="overflow:scroll">
                        <div id="pie_chart" style="width:350px; height:320px;">
                            @php
                                ...
                                $users = \App\User::where('admin_id', $admin_id)->get();
    ...
    @push('scripts')
        <script>
            function copyNameStore() {
                let nameStore = document.querySelector('.storename');
                const copyText = nameStore.innerHTML;
