...
@section('main-content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary float-left">قائمة المنتجات</h6>
            <a href="{{ route('product.create') }}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip"
                data-placement="bottom" title="Add User"><i class="fas fa-plus"></i>لإضافة منتج </a>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product)
                                ...
                                <tr>
                                    ...
                                    <td> {{ ucfirst($product->brand->title ?? 'no') }}</td>
                                    <td>
                                        @if ($product->stock > 0)
                                    ...
                                    <td>
                                        @if ($product->photo)
                                            @php
                                                $photo = explode(',', $product->photo); // في حال انه كان للمنتج اكثر من صورة
                                                // dd($photo);
                                            @endphp
                ...
                @else
                    <h6 class="text-center">لا يتوفر منتجات!!! الرجاء قم بإضافة منتجات جديدة</h6>
                @endif
            </div>
        </div>
    </div>
