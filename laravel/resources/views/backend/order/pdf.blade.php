    ...
    @if ($order)
        ...
        <div class="invoice-header">
            ...
            <div class="float-right site-address">
                <h4>{{ env('APP_NAME') }}</h4>
                <p>{{ env('APP_ADDRESS') }}</p>
                <p>الموبايل: <a href="tel:{{ env('APP_PHONE') }}">{{ env('APP_PHONE') }}</a></p>
                <p>البريد الالكتروني: <a href="mailto:{{ env('APP_EMAIL') }}">{{ env('APP_EMAIL') }}</a></p>
            </div>
        ...
        <div class="invoice-description">
            ...
            <div class="invoice-right-top float-right" class="text-right">
                <h3>الفاتورة #{{ $order->order_number }}</h3>
        ...
        <section class="order_details pt-3">
            ...
            <table class="table table-bordered table-stripe">
                <thead>
                    <tr>
                        <th scope="col" class="col-6">منتج</th>
                        <th scope="col" class="col-3">الكمية</th>
                        <th scope="col" class="col-3">الإجمالي</th>
                    </tr>
                </thead>
                <tbody>
