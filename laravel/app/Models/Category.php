...
{
    protected $fillable=['title','slug','summary','photo','status','is_parent','parent_id','added_by','admin_id'];
    ...
    public static function countActiveCategory(){
        ...
        $data=Category::where('status','active')->where('admin_id',$admin_id)->count();
        if($data){
            return $data;
        }
        return 0;
